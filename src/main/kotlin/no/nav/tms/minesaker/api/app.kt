...
fun main() {
    ...
    val navnFetcher = NavnFetcher(httpClient, environment.pdlApiUrl, environment.pdlBehandlingsnummer, tokenExchanger)

    val fullmaktConsumer = FullmaktConsumer(httpClient, tokenExchanger, environment.reprFullmaktUrl)
    ...
    val digiSosConsumer = DigiSosConsumer(httpClient, tokenExchanger, environment.digiSosEndpoint)
    val sakService = SafService(safConsumer, tokenExchanger)
