...
dependencies {
    ...
    implementation(TmsTokenSupportBeta.idportenSidecar)
    implementation(TmsTokenSupportBeta.tokendingsExchange)

    testImplementation(Junit.api)
    testImplementation(Ktor.Test.clientMock)
    testImplementation(Ktor.Test.serverTestHost)
    testImplementation(TmsTokenSupportBeta.idportenSidecarMock)
