...
dependencies {
    ...
    implementation("com.github.navikt.tms-ktor-token-support:token-support-idporten:cookie-samesite-SNAPSHOT")
    implementation("com.github.navikt.tms-ktor-token-support:token-support-tokendings-exchange:cookie-samesite-SNAPSHOT")
    implementation("com.github.navikt.tms-ktor-token-support:token-support-authentication-installer:cookie-samesite-SNAPSHOT")
    implementation("com.github.navikt.tms-ktor-token-support:token-support-tokenx-validation:cookie-samesite-SNAPSHOT")
