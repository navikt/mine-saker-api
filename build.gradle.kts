...
dependencies {
    ...
    implementation("com.github.navikt.tms-ktor-token-support:token-support-idporten:cookie-samesite-domain-SNAPSHOT")
    implementation("com.github.navikt.tms-ktor-token-support:token-support-tokendings-exchange:cookie-samesite-domain-SNAPSHOT")
    implementation("com.github.navikt.tms-ktor-token-support:token-support-authentication-installer:cookie-samesite-domain-SNAPSHOT")
    implementation("com.github.navikt.tms-ktor-token-support:token-support-tokenx-validation:cookie-samesite-domain-SNAPSHOT")
