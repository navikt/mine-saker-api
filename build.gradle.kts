...
dependencies {
    ...
    implementation("com.github.navikt.tms-ktor-token-support:token-support-authentication-installer:cookie-samesite-domain-path-SNAPSHOT")
    implementation("com.github.navikt.tms-ktor-token-support:token-support-tokenx-validation:cookie-samesite-domain-path-SNAPSHOT")
